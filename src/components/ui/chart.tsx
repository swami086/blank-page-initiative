      ...
      dangerouslySetInnerHTML={{
        __html: [
          ...
          ...colorConfig.map(([key, itemConfig]) => {
            const color = itemConfig.theme?.[typeof document !== "undefined" ? "light" : "light"] || itemConfig.color
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      const value =
        !labelKey && typeof label === "string"
          ? ({} as any)[label as keyof any]?.label || label
          : itemConfig?.label
...
// Utility function to get payload configuration
const getPayloadConfigFromPayload = (config: Record<string, any>, payload: any, key: string) => {
